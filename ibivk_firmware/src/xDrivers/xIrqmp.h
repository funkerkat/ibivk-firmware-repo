...
#define IRQMP_TIMER2	ALLOWED	//ALLOWED
#define IRQMP_TIMER3	FORBIDDEN
#define IRQMP_B1553BRM	FORBIDDEN // ALLOWED
// external interrupts:
#define IRQMP_1HZ		ALLOWED
#define IRQMP_320MS		ALLOWED

// interrupts map:
#define IRQMP_1			(NOTUSED			<< 1)
#define IRQMP_2			(IRQMP_UART1		<< 2)
#define IRQMP_3			(IRQMP_UART2		<< 3)
#define IRQMP_4			(IRQMP_320MS		<< 4)
